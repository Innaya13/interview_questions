...
2. Согласованность (Consistency) - гарантия, что выполнение транзакции не нарушит целостность данных в базе. Транзакция не может нарушить ограничения целостности базы данных, такие как связи между таблицами и ограничения на допустимые значения полей.
